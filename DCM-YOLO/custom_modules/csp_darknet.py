...
from mmyolo.models import CSPLayerWithTwoConv, SPPFBottleneck
from mmyolo.models.utils import make_divisible, make_round
from mmyolo.models.backbones.base_backbone import BaseBackbone
from custom_modules.SPD import SPD
from custom_modules.SPPFCSPC_CBAM import SPPFCSPC
...
class YOLOV8CSPDarknet(BaseBackbone):
    ...
    def build_stage_layer(self, stage_idx: int, setting: list) -> list:
        ...
        spd_layer = SPD()
        stage.append(spd_layer)
        in_channels=out_channels*2

        from .DCNv4_op.DCNv4.modules.C2fDCNv4 import C2f_DCNv4
        csp_layer = C2f_DCNv4(
            in_channels,  # in_channels
            out_channels)
        stage.append(csp_layer)

        # Optionally, add SPP if needed
        if use_spp:
            spp = SPPFBottleneck(
                out_channels,
                out_channels,
